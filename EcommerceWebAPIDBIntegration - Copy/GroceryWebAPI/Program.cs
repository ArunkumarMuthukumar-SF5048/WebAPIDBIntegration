using GroceryWebAPI.Controllers;
...
builder.Services.AddAuthentication("MyCookieAuth")
    .AddCookie("MyCookieAuth", options =>
    {
        ...
        options.LoginPath = "/api/medicalstore/auth/login";
        options.LogoutPath = "/api/medicalstore/auth/logout";
        options.AccessDeniedPath = "/api/medicalstore/auth/denied";
